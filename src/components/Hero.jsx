...
const Hero = () => {
  ...
  return (
    <div className="hero">
      {/* Correo lateral */}
      <a href="https://mail.google.com/mail/u/0/#inbox?compose=VpCqJXKbWZMLphQFXwrnckhpJtLRTlKRRtdBXPPxTNmCBmGsKlDDsCrTdGFvHGFTFLknqHV" target="blank">
      ...
      <div className="hero__menu">
        <a onClick={() => scrollToSection('sobremi')} className={activeSection === 'sobremi' ? 'active' : ''}>
          About me
        </a>
